...
public class AttrGroupController {
    ...
    public ResponseVo<List<GroupVo>>querryAttrGroupById(@PathVariable("catId")Long catId){
        List<GroupVo> voList=attrGroupService.querryAttrGroupById(catId);
        return ResponseVo.ok(voList);
    }
}
