...
public class UserController {
    ...
    public ResponseVo<Object> sendMessage(@PathVariable("phone")String phone){
        Boolean result=userService.sendMessage(phone);
        return ResponseVo.ok(result);
    }
    @PostMapping("register")
    public void register(@RequestBody UserEntity userEntity, @RequestParam("code")String code){
        userService.register(userEntity,code);

    }
    @GetMapping("query")
    public ResponseVo queryUser(@RequestParam String username,@RequestParam String password){
        UserEntity userEntity=userService.queryUser(username,password);
